...
SV_SRC := $(shell $(PACKAGES_DIR)/python/bin/python -m mkdv files tblink-rpc-hdl::uvm-python-remote-obj-tb -t verilogSource -t systemVerilogSource -f sv,sv-uvm)
SV_INC := $(shell $(PACKAGES_DIR)/python/bin/python -m mkdv files tblink-rpc-hdl::uvm-python-remote-obj-tb -i -t verilogSource -t systemVerilogSource -f sv,sv-uvm)
